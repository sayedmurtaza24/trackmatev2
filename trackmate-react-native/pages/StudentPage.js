...
const StudentPage = () => {
    ...
    const fieldOptions = useSelector(store => store.teacher.currentTeacher.fieldOptions);
        ...
        <View style={styles.root}>
            ...
            <View style={styles.fieldOptionHeader}>
                {fieldOptions.map(field => {
                    return (
                        <View key={field.name + field.valueRange} style={styles.fieldOptionHeaderTile}>
                            <Text style={{ flexWrap: 'nowrap', width: 150 }}>{field.name}</Text>
                        </View>
                    )
                })}
            </View>
